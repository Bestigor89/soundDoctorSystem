            ...
            <table class="table table-index w-full">
                ...
                @forelse($users as $user)
                    <tr>
                        ...
                        <td>@empty(!$user->getAdditionalData)
                                {{ $user->getAdditionalData->getPhone() ?? '' }}
                            @endempty
                        </td>
                        <td>
                            @empty(!$user->getAdditionalData)
                                {{$user->getAdditionalData->getBirthdayDate()}}
                            @endempty
                        </td>
                        {{--                            <td>--}}
                        {{--                                {{ $user->locale }}--}}
